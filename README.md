...
🧠 Note: This environment variable is used directly in the code (in src/hooks/api.js).
There’s no need to modify any JavaScript files — just update the .env file.
